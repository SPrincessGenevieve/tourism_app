  ...
  return (
    <DialogPortalPrimitive>
      ...
      <DialogContentPrimitive
        className={cn(
          "fixed top-[50%] left-[50%] z-50 grid max-h-[90%] w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto rounded-lg border bg-background p-6 shadow-lg sm:max-w-lg",
          className
        )}
        {...props}
      >
